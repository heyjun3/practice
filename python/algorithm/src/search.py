...
def binary_search_recursive(numbers: List[int], value: int) -> int:
    def _binary_search(numbers: List[int], value: int, left: int, right: int):
        if left > right:
            return -1
...
if __name__ == '__main__':
    ...
    print(binary_search_recursive(nums, 11))